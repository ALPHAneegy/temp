...
local Players = game:GetService("Players")
local player = Players.LocalPlayer
local title = ("AMERICAN Hub PAID VERSION | Hello -%s"):format(displayName)
...
local antiAfkSwitch = MainTab:AddSwitch("Anti Afk")
local antiAfkSwitch = loadstring(game:HttpGet("https://raw.githubusercontent.com/ALPHAneegy/antiAFK/refs/heads/main/antiAfk.lua"))()
antiKnockbackSwitch:Set(true)
...
Credits:AddLabel("Script Made by username:TheRealDeath")
Credits:AddLabel("rror271")
Credits:AddLabel("Si hallas algun bug o error mandame md al tik tok")
Credits:AddLabel("User de tik tok: murxto")
