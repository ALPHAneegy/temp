...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/ALPHAneegy/library-script/refs/heads/main/README7.md", true))()
...
equiper:AddSwitch("Equip / Unequip All Master Legend Pets", function(state)
    getgenv().equipMasterLegend = state
    v37("Master Legend", state)
end)
...
do
    ...
    pcall(function() _G.TrackerCore.SpyTab = window:AddTab("Spy Stats Player ") end)
...
infoTab:AddLabel("")
local wLabel = infoTab:AddLabel("Version: 2")
wLabel.TextSize = 30
